...
class SnippetValidator(private val restTemplate: RestTemplate) {
    fun validateSnippet(
        ...
        return try {
            ...
            throw ConnectException("Connection refused: Unable to reach the Parser service at $url")
                .apply { initCause(e) }
        } catch (e: RestClientException) {
            throw RestClientException("Error making the request to the Parser service", e)
        }
    }
}
